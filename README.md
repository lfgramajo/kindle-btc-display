...
Example 800×600 grayscale dashboard using GTQ as the configured secondary fiat:

![Kindle Bitcoin Price Display example output with GTQ](docs/screenshots/kindle-btc-display-example.jpg)
