...
Example 800×600 grayscale dashboard generated by the v1.7.0 renderer with GTQ as the configured secondary fiat:

![Kindle Bitcoin Price Display example output with GTQ](docs/screenshots/kindle-btc-display-example.png)
